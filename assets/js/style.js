document.addEventListener("DOMContentLoaded", () => {
  let darkModeToggle = document.querySelector("#theme-button");
  let darkModeToggleMobile = document.querySelector("#theme-button-mobile");

  while (!darkModeToggle || !darkModeToggleMobile) {
    console.log("Waiting for dark mode toggle elements to load...");
    darkModeToggle = document.querySelector("#theme-button");
    darkModeToggleMobile = document.querySelector("#theme-button-mobile");
  }
  console.log("Dark mode toggle elements loaded successfully.");
